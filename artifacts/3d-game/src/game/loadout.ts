...
export const SKIN_DEFINITIONS: Record<SkinId, SkinDefinition> = {
  ...
  worker_miner: {
    ...
    miniBonusType: "coins",
    miniBonusValue: 0.03,
    compatibleClasses: ["miner", "tank", "knight"],
    previewOffset: [0, -1.08, 0],
    previewScale: 1.35,
    animationProfile: "humanoid",
  },
  ninja_shadow: {
    ...
    miniBonusType: "crit",
    miniBonusValue: 0.02,
    compatibleClasses: ["assassin", "ranger"],
    previewOffset: [0, -1.08, 0],
    previewScale: 1.35,
    animationProfile: "humanoid",
  },
  ...
  soldier_scout: {
    ...
    miniBonusType: "move_speed",
    miniBonusValue: 0.03,
    compatibleClasses: ["ranger", "assassin", "mage"],
    previewOffset: [0, -1.08, 0],
    previewScale: 1.35,
    animationProfile: "humanoid",
  },
