...
export const ENEMY_CONFIG: Record<EnemySubType, {
  ...
  grunt:  { label: "Bone Grunt",    baseHp: 3.2,  speed: 3.45, damage: 14, mechanics: ["melee"],                 xp: 14,  coinValue: 3,  scale: 0.98, color: "#e5e2cf", assetPath: "/assets/enemies/Skeleton.fbx", modelScale: 0.010, modelYOffset: -1.1 },
  charger:{ label: "Angry Serpent", baseHp: 4.2,  speed: 3.05, damage: 22, mechanics: ["charge"],                xp: 23,  coinValue: 5,  scale: 1.08, color: "#ff9d4d", assetPath: "/assets/enemies/Snake_angry.fbx", modelScale: 0.012, modelYOffset: -1.1 },
  shooter:{ label: "Venom Wasp",    baseHp: 3.0,  speed: 2.9,  damage: 13, mechanics: ["shoot"],                 xp: 20,  coinValue: 5,  scale: 1.0,  color: "#ffd45d", assetPath: "/assets/enemies/Wasp.fbx", modelScale: 0.010, modelYOffset: -1.0 },
  brute:  { label: "Stone Slime",   baseHp: 9.2,  speed: 2.15, damage: 30, mechanics: ["slam", "melee"],         xp: 38,  coinValue: 8,  scale: 1.42, color: "#7dc96e", assetPath: "/assets/enemies/Slime.fbx", modelScale: 0.014, modelYOffset: -1.1 },
  ghost:  { label: "Venom Wasp",    baseHp: 2.2,  speed: 5.1,  damage: 12, mechanics: ["shoot"],                 xp: 16,  coinValue: 3,  scale: 1.0,  color: "#8bb7ff", assetPath: "/assets/enemies/Wasp.fbx", modelScale: 0.009, modelYOffset: -1.0 },
  zombie: { label: "Moss Slime",    baseHp: 4.4,  speed: 2.8,  damage: 17, mechanics: ["melee"],                 xp: 18,  coinValue: 4,  scale: 1.15, color: "#4bd46a", assetPath: "/assets/enemies/Slime.fbx", modelScale: 0.012, modelYOffset: -1.1 },
  creeper:{ label: "Angry Serpent", baseHp: 3.2,  speed: 4.1,  damage: 28, mechanics: ["explode"],               xp: 22,  coinValue: 5,  scale: 1.05, color: "#f6d24a", assetPath: "/assets/enemies/Snake_angry.fbx", modelScale: 0.012, modelYOffset: -1.1 },
  elite:  { label: "Elite Skeleton", baseHp: 7.2, speed: 3.6,  damage: 24, mechanics: ["shoot", "melee"],         xp: 42,  coinValue: 9,  scale: 1.35, color: "#ff4f86", assetPath: "/assets/enemies/Skeleton.fbx", modelScale: 0.012, modelYOffset: -1.1 },
  boss10: { label: "Gate Dragon",   baseHp: 34,   speed: 3.0,  damage: 26, mechanics: ["shoot", "melee"],         xp: 140, coinValue: 28, scale: 2.25, color: "#ff8f3d", assetPath: "/assets/enemies/Dragon.fbx", modelScale: 0.016, modelYOffset: -1.8 },
  boss20: { label: "Void Dragon",   baseHp: 58,   speed: 3.35, damage: 34, mechanics: ["shoot","melee","explode"], xp: 240, coinValue: 44, scale: 2.75, color: "#b06cff", assetPath: "/assets/enemies/Dragon.fbx", modelScale: 0.018, modelYOffset: -1.8 },
};
